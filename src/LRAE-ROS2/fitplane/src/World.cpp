...
World::World(const float &resolution, rclcpp::Node::SharedPtr nh)
{
    ...
    nh_->declare_parameter<std::string>("PointCloud_Map_topic", PointCloud_Map_topic);
    nh_->declare_parameter<std::string>("Grid_Map_topic", Grid_Map_topic);
    nh_->declare_parameter<std::string>("PointCloud_topic", PointCloud_topic);
    nh_->declare_parameter<bool>("use_ex_range", use_ex_range_);
    nh_->declare_parameter<double>("ex_robot_back", ex_robot_back_);
    nh_->declare_parameter<double>("ex_robot_front", ex_robot_front_);
    nh_->declare_parameter<double>("ex_robot_right", ex_robot_right_);
    nh_->declare_parameter<double>("ex_robot_left", ex_robot_left_);
...
{   
    ...
    {
        // RCLCPP_ERROR(this->get_logger(),"Can not initialize the map with an empty point cloud!");
        return;
    }
    clearMap();
    cloud_near_.clear();
