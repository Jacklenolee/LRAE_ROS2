...
namespace FitPlane
{
    ...
    bool PlaneMap::InitPlaneMap()
    {
        ...
        {
            // RCLCPP_ERROR(this->get_logger(), "No world!");
    ...
    void PlaneMap::visSurf(const PlaneMap &planemap, std::shared_ptr<rclcpp::Publisher<sensor_msgs::msg::PointCloud2>> surf_vis_pub)
    {
    ...
    bool PlaneMap::pubPlaneGridMap(const PlaneMap &planemap)
    {
        ...
        plane_Occmap_.header.stamp =clock.now();
