...
public:
    ...
    bool InitPlaneMap();
    void clearPlaneMap();
    void PointCloudMapCallback(const sensor_msgs::msg::PointCloud2& PointCloud_Map);

    bool init();
    bool getPlaneMap();
    Plane FitPlane(Eigen::Vector3d& p_surface,World* world,const double &radius);

    void visSurf(const PlaneMap &planemap,rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr surf_vis_pub);
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr plane_grid_map_pub_;
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr trav_cloud_pub;
